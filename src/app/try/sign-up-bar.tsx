...
export function SignUpBar({
  ...
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--color-line)] bg-[var(--color-paper)]"
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between md:gap-8 md:px-12 md:py-6">
        <div className="flex-1">
          ...
          <h2 className="mt-1.5 font-serif text-2xl font-light leading-tight text-[var(--color-ink)] md:text-3xl">
            Save &amp; download your <span className="italic">batch</span>.
          </h2>
          <p className="mt-1.5 font-mono text-[10px] tracking-[0.16em] text-[var(--color-ember)] uppercase">
        ...
        <div className="flex flex-col items-stretch gap-2 md:flex-row md:items-center md:gap-4">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-[var(--color-ember)] px-6 py-3.5 text-sm font-medium text-[var(--color-cream)] transition-transform hover:scale-[1.02] hover:bg-[#a83c18] md:px-8 md:py-4"
          >
            Create your account →
          </button>
          <button
      ...
      <div className="border-t border-[var(--color-line)] bg-[var(--color-paper-2)]/60">
        <div className="mx-auto max-w-6xl px-6 py-2 text-center font-mono text-[10px] tracking-[0.18em] text-[var(--color-ink-4)] uppercase md:px-12">
