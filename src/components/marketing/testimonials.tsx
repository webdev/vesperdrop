  ...
  return (
    <section className="bg-paper py-24 md:py-32">
      <Container width="marketing">
        ...
        <div className="grid grid-cols-1 gap-px overflow-hidden rounded-xl border border-line-soft bg-line-soft md:grid-cols-3">
          {REVIEWS.map((r) => (
            <figure
              key={r.name}
              className="flex h-full flex-col bg-surface p-8 md:p-10"
            >
              <blockquote className="font-serif text-[clamp(1.125rem,1.6vw,1.375rem)] leading-[1.4] tracking-[-0.01em] text-ink">
                &ldquo;{r.quote}&rdquo;
              </blockquote>
